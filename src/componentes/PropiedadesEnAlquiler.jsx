...
import "../assets/scss/_03-Componentes/_PropiedadesEnAlquiler.scss";
...
const PropiedadesEnAlquiler = () => {
  ...
  return (
    <div className="propiedades-en-alquiler">
      <div className="filter-buttons-alquiler">
        <button
      ...
      {filteredData.length === 0 ? (
        ...
        <div className="data-container-alquiler">
          {filteredData.map((item) => (
            <div key={item.id} className="data-item-alquiler">
              <h3>{item.Nombre}</h3>
  ...
  <div className="share-buttons-en-alquiler">
